...
void Generator::Eunits_generator(Game *game, int n, int es, int et, int eg, int prop) {
    ...
    if (A >= prop) {
        for (int i = 0; i < n; i++) {
            ...
            if (B <= es) {
                auto earth_soldier = new EarthSoldier(game, Ecount++, current_time,
                ...
                auto earth_tank = new EarthTank(game,Ecount++, current_time,
                    random_range(min_Epower, max_Epower),
                    random_range(min_Ehealth, max_Ehealth),
                    random_range(min_Ecapacity, max_Ecapacity));
                ...
                auto earth_gunnery = new EarthGunnery(game, Ecount++, current_time,
                    random_range(min_Epower, max_Epower),
                    random_range(min_Ehealth, max_Ehealth),
                    random_range(min_Ecapacity, max_Ecapacity));
    ...
    if (A >= prop) {
        for (int i = 0; i < n; i++) {
            ...
            if (B <= as) {
                ...
                auto alien_soldier = new AlienSoldier(game, 2000 + Acount++, current_time,
                ...
                auto alien_monster = new AlienMonster(game, Ecount++, current_time,
                                                      random_range(min_Epower, max_Epower),
                                                      random_range(min_Ehealth, max_Ehealth),
                                                      random_range(min_Ecapacity, max_Ecapacity));
                ...
                auto alien_drone = new AlienDrone(game, Ecount++, current_time,
                                                      random_range(min_Epower, max_Epower),
                                                      random_range(min_Ehealth, max_Ehealth),
                                                      random_range(min_Ecapacity, max_Ecapacity));
